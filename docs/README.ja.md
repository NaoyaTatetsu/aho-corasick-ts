# aho-corasick-ts（日本語ドキュメント）

英語版は[README.md](../README.md)、詳細は[usage.md](usage.md)・[api.md](api.md)・[internals.md](internals.md)・[development.md](development.md)にあります。このページはそれらすべてを日本語でまとめたものです。
